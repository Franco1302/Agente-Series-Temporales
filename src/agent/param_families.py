...
#: Parámetros que mapean nombres del lenguaje natural a códigos/etiquetas cortos
#: (enums). El LLM tiene permiso para traducirlos: "normal" → distribution_type=1,
#: "diaria" → frequency='D', "Kolmogorov-Smirnov" → method='KS'. Cualquier otro
#: parámetro NO listado aquí debe venir de sesión o del mensaje del usuario
#: (saneamiento en ``reasoning._sanitize_open_data_args``).
SEMANTIC_ENUMS: frozenset[str] = frozenset({
    "distribution_type",
    "trend_type",
    "pattern_type",
    "method",
